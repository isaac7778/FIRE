...
for seed in {1..3}; do
    ...
    python train.py --seed "$seed" --benchmark "$benchmark" --model RESNET18 --task CIFAR10 --cbp-enable True --cbp-replacement-rate 1e-5 --cbp-maturity-threshold 1000
    python train.py --seed "$seed" --benchmark "$benchmark" --model RESNET18 --task CIFAR10 --redo-enable True --redo-threshold 0.05
    python train.py --seed "$seed" --benchmark "$benchmark" --model RESNET18 --task CIFAR10 --regen-coef 1e-5
    python train.py --seed "$seed" --benchmark "$benchmark" --model RESNET18 --task CIFAR10 --snr-enable True --snr-tau-percentile 0.92
    ...
    python train.py --seed "$seed" --benchmark "$benchmark" --model TinyViT --task CIFAR100 --regen-coef 1e-4
    python train.py --seed "$seed" --benchmark "$benchmark" --model TinyViT --task CIFAR100 --snr-enable True --snr-tau-percentile 0.96
    ...
    python train.py --seed "$seed" --benchmark "$benchmark" --model VGG16 --task TinyImageNet --dash-alpha 0.1 --dash-lambda 0.1
    python train.py --seed "$seed" --benchmark "$benchmark" --model VGG16 --task TinyImageNet --parseval-reg-enable True --parseval-reg-coef 1e-4
    python train.py --seed "$seed" --benchmark "$benchmark" --model VGG16 --task TinyImageNet --cbp-enable True --cbp-replacement-rate 1e-5 --cbp-maturity-threshold 1000
    python train.py --seed "$seed" --benchmark "$benchmark" --model VGG16 --task TinyImageNet --redo-enable True --redo-threshold 0.01
    python train.py --seed "$seed" --benchmark "$benchmark" --model VGG16 --task TinyImageNet --regen-coef 1e-5
    python train.py --seed "$seed" --benchmark "$benchmark" --model VGG16 --task TinyImageNet --snr-enable True --snr-tau-percentile 0.99
